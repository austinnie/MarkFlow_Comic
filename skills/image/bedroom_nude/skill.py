...
class BedroomNude:
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        logger.info(f"BedroomNude v{self.version} 蛻晏ｧ句喧螳梧・")
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            prompt = base_prompt + "bedroom background, soft lighting, warm atmosphere, high quality, masterpiece, 8k, photorealistic"
    ...
    def __repr__(self):
        return f"<BedroomNude(name={self.name}, version={self.version})>"